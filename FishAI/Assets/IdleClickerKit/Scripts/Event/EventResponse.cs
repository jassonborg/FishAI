...
namespace IdleClickerKit
{
	...
	public class EventResponse
	{
		...
		public override bool Equals (object obj)
		{
			...
			return responseType == other.responseType && delay == other.delay && targetGameObject == other.targetGameObject && targetComponent == other.targetComponent && message == other.message && overrideState == other.overrideState && newSprite == other.newSprite && intValue == other.intValue && vectorValue == other.vectorValue && boolValue == other.boolValue && floatValue == other.floatValue;
		}
		...
		{
			unchecked {
				return responseType.GetHashCode () ^ delay.GetHashCode () ^ (targetGameObject != null ? targetGameObject.GetHashCode () : 0) ^ (targetComponent != null ? targetComponent.GetHashCode () : 0) ^ (message != null ? message.GetHashCode () : 0) ^ (overrideState != null ? overrideState.GetHashCode () : 0) ^ (newSprite != null ? newSprite.GetHashCode () : 0) ^ intValue.GetHashCode () ^ vectorValue.GetHashCode () ^ boolValue.GetHashCode () ^ floatValue.GetHashCode ();
			}
		}
